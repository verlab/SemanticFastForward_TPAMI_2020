%> @file generate_transistion_costs.m
%>
%> Function to generate the Appearance and Semantic Costs from the MIFF paper and save the file.
%> 
%> Functional call:
%> @code
%> generate_transistion_costs( inputVideo, speedupRate, semantic_extractor )
%> @endcode
